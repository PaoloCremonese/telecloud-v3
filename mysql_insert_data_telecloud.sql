...
INSERT INTO account (dtype, active, agroup, company, email, firstname, lastname, password, logincount, status) VALUES ('dtype', 1, 'Guest', 'guest', 'guest', 'guest', 'guest', 'guest', 0, 1);
INSERT INTO site (comment, name, phone, account_id) VALUES ('Sito di Ghezzano', 'Ghezzano', '050-878725', 1);
INSERT INTO site (comment, name, account_id) VALUES ('The Guest Site', 'unSito', 2);
...
INSERT INTO device (comment, name, programmazione, site_id) VALUES ('The Guest Device', 'Guest TeledataONE', 'Programmazione JSON della TeledataONE del sito di Ghezzano !', 2);
COMMIT;
